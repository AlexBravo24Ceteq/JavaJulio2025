...
public class ArrayBidimensional {
    ...
    public static void main(String[] args) {
        /*
        Array Bidimensional. También es conocido como matriz.
        Y pasa a ser una estructura que nos permite almacenar más
        elementos de un mismo tipo de dato pero ahora presentandolos
        de forma tabular. Es decir, una dimension va a actuar
