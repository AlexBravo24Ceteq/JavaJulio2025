...
public class MetodosString {
    ...
    public static void main(String[] args) {
        ...
        //cadena de texto, es decir, cuenta todos los caracteres incluyendo
        ...
        //si lo necesitará para un uso posterior, puedo guardar ese valor
        ...
        //.toLowerCase - convierte la cadena de texto a letras minusculas
        System.out.println("Probando el método .toLowerCase()");
        System.out.println(fecha.toLowerCase());

        String fechaMinusculas = fecha.toLowerCase();
        ...
        //son iguales, si no lo son, devuelve un valor false
