...
public class Cajero implements IMetodos {
    ...
    //que se encargaran de resolver las Operaciones
    //(logica)
    ...
    //Vamos a declarar una variable auxiliar para
    //incrementa el numero de folio del Ticket
    private int folio=1;
    ...
    public Cuenta consultar(int numCuenta) {
        ...
        Cuenta cuenta = null;
        //Buscamos la cuenta en el Map (Que simula la base de datos)
        //por medio del numero de cuenta (key del Map)

        cuenta = cuentas.get(numCuenta); //Si la cuenta existe, guardamos
        //esa info en el objeto cuenta
    ...
    public Ticket retirar(int numCuenta, double monto) {
        ...
        if (consultar(numCuenta) != null){
            ...
            //Validamos que el cajero no me pueda dar dinero,
            //si excedo su limite diario
            if (monto > 9000){
        ...
        else{ //Si al buscar la cuenta no existe
    ...
    public Ticket depositar(int numCuenta, double monto) {
        ...
        if (consultar(numCuenta)!= null){
            Cuenta cuenta = consultar(numCuenta);
            //Validamos si el monto que queremos depositar es mayor al saldo
            //maximo de la cuenta
            if(monto > cuenta.getSaldoMax()){
                ...
                System.out.println("El monto haria exceder a la cuenta en su saldo maximo permitido");
                return ticket;

            } else if (monto > 10000) {
                System.out.println("No se pueden realizar depositos mayores a 10000 Por favor pase a ventanilla");
                return ticket;
