...
public class Condicionales13_AADLCV {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Introduce el monto de la donación en dólares: ");
        double donacion = entrada.nextDouble();

        double salud, comedor, inversion;

        if (donacion >= 10000) {
            salud = donacion * 0.30;
            comedor = donacion * 0.50;
            inversion = donacion - salud - comedor;
        } else {
            salud = donacion * 0.25;
